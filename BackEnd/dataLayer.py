...
def add_expense(user_id, name, amount, term, occurrence):
    items.insert_one({"user": user_id, 'name': name, "amount": amount,
                     "term": term, "direction": "expense", "occurrence": occurrence})


def add_income(user_id, name, amount, term, occurrence):
    items.insert_one({"user": user_id, 'name': name, "amount": amount,
                     "term": term, "direction": "income", "occurrence": occurrence})
